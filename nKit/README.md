...
ماژول nKit هسته مدیریت ابزارهای مجموعه AutoCAD Tools است.

این ماژول برای نصب، بروزرسانی، بارگذاری و مدیریت ابزارهای AutoLISP در محیط AutoCAD طراحی شده است.
...
ماژول nKit بر اساس یک ایده ساده ساخته شده است:
...
ساختار nKit از سه لایه تشکیل شده است:
...
3. مخزن آنلاین
   - فایل‌های JSON
   - سایت GitHub و سایتهای nasiri-m با دامنه های .com و .ir به عنوان منبع
```
...
ماژول nKit ابزارهای AutoCAD را از حالت اسکریپت‌های پراکنده به یک اکوسیستم مدیریت‌شده تبدیل می‌کند.
